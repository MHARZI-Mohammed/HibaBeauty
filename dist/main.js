...
const addToCartButtons = document.querySelectorAll('.bg-pink-600');
// ========== INIT ==========
function init() {
...
function showToast(message, type) {
    ...
    toast.id = 'toast';
    toast.className = `fixed bottom-4 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-lg text-white font-medium shadow-lg z-50 transition-opacity ${type === 'success' ? 'bg-green-600' : 'bg-red-600'}`;
